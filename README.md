...
- The company is in a high-growth phase and is looking to:
    - **Expand into high-potential markets**
    - **Identify and focus on strategic product categories**
- **Data dictionary:**
  <img width="1210" height="797" alt="image" src="https://github.com/user-attachments/assets/aa63c58e-1685-4250-974a-55ce52b1b716" />
- **Business Question:**
    - What is the overall business performance across all markets?
    - Which international markets show the strongest potential for expansion?
    - Which product categories perform best in each international market?
